...
export const environment = {
  ...
  DELETE_RIDE: [{
    header1: 'Estas seguro de eliminar tu oferta de viaje?',
    header2: 'Por favor informanos por que deseas hacerlo.it\'Ayudanos a mejorar nuestro servicio.',
    listheader: 'Tu motivo',
    textarea: false,
  },
  {
    label: 'Motivo',
    select: [{ reason: 'Algo paso, no podre recogerte' },
    { reason: 'No aparecio la persona' },
    { reason: 'No salgo a la hora indicada.' },
    { reason: 'Cambio mi horario' },
    { reason: 'Ya no tengo clases' },
    { reason: 'Tuve una emergencia con mi vehículo' },
    { reason: 'Debo tomar otra ruta.' },
    { reason: 'Otro motivo' },
    ],
    textarea: false,
  },
  ...
  {
    header1: 'Nota: Tu puntaje de cancelacione s visible.',
  ...
  EDIT_RIDE: [{
    head: 'Destino y paradas',
    route: 'journey'
  }, {
    head: 'Contribucion del pasajero',
    route: 'edit-price-list'
  }, {
    head: 'Opciones de pasajero',
    route: 'passengers-option'
  }],
  NOTIFICATIONS: [{
    title: 'Sistema',
    subtitle: 'Solicitud #1234 ha sido completada...',
    iconUrl: 'assets/success.png',
  },
  {
    title: 'Promocion',
    subtitle: 'Obten 3 cupones',
  ...
  {
    title: 'Sistema',
    subtitle: 'Solicitud #2312 ha sido cancelada...',
    iconUrl: 'assets/error.png',
  },

  {
    title: 'Sistema',
    subtitle: 'Solicitud #2312 ha sido completada',
    iconUrl: 'assets/success.png',
  },
  ],
  DOCUMENTS: [{
  ...
  //   header: 'email',
  //   label: 'Email',
  //   model: 'davidcortes@unisangil.edu.co',
  //   button: 'Save email'
  // }, 
  // {
  ...
  PREFERENCE: [{
    icon: 'chatbubbles',
    header: 'Conversacion',
    placeholder: 'Soy callado',
    list: [{
      model: 'the',
      chattiness: 'Soy callado'
    },
    {
      model: 'depending',
      chattiness: 'Converso dependiendo mi humor'
    }, {
      model: 'love',
      chattiness: 'Me encanta'
    }]
  }, {
    placeholder: 'Puedes fumar en el vehiculo',
    icon: 'location-outline',
    header: 'Humo',
    list: [{
      model: 'no',
      chattiness: 'No puedes fumar'
    },
    {
      model: 'know',
      chattiness: '420 friendly'
    }, {
      model: 'ciggrette',
      chattiness: 'No me molesta si fumas'
    }]
  }, {
    placeholder: 'Amo la musica',
    icon: 'musical-notes',
    header: 'Musica',
    list: [{
      model: 'silence',
      chattiness: 'Silencio es sagrado'
    },
    {
      model: 'do',
      chattiness: 'Amo la musica'
    }, {
      model: 'it',
      chattiness: 'Pon lo que quieras'
    }]
  }, {
    placeholder: 'Sin mascotas',
    icon: 'paw',
    header: 'Animales',
    list: [{
      model: 'pets',
      chattiness: 'No pets pls'
    },
    {
      model: 'don',
      chattiness: 'No se'
      ...
      model: 'welcome',
      chattiness: 'Son bienvenidos. Woof!'
    }]
  }],
  COUNTRIES: [
    {
  ...
  {
    email: 'davidcortes@unisangil.edu.co',
    toggle: false,
  ...
  RIDES_LIST: [{
    ...
    name: 'Javier Rios',
    car: 'Toyota prado 2007 Blanco',
    numberPlate: 'EDS-342',
    cost: '10000'
  }, {
    image: 'assets/image/chat2.jpg',
    name: 'Julia Barrera',
    car: 'Chevrolet Spark 2010 Negro',
    numberPlate: 'FRS-756',
    cost: '8000'
    ...
    name: 'Julian Cortes',
    car: 'Toyota Hilus 2017 Gris',
    numberPlate: 'LKJ-787',
    cost: '10000'

  }, {
    image: 'assets/image/chat7.jpg',
    name: 'Cristina Martines',
    car: 'Sisuki Jimmy  2019 Rojo',
    numberPlate: 'EFG-235',
    cost: '9000'
