...
export const environment = {
  ...
  DELETE_RIDE: [{
    header1: 'Estas seguro que quieres borrarlo?',
    header2: 'Cuentanos por que .it\'Nos ayudara a mejorar.',
    listheader: 'Razones',
    textarea: false,
  },
  {
    label: 'Razones',
    select: [{ reason: 'Algo paso, debo cancelarlo' },
    { reason: 'Cambie de horario' },
    { reason: 'Cancelacion de clase' },
    { reason: 'Tuve que cambiar de ruta.' },
    { reason: 'El precio es incorrecto.' },
    { reason: 'Mi vehiculo se descompuso.' },
    { reason: 'Tuve que editar la oferta.' },
    { reason: 'Otra razon' },
    ],
    textarea: false,
  },
  {
    label: 'MORE DETAILS',
    placeholder: 'Danos los detalles.',
    textarea: true,
  },
  {
    header1: 'Nota: tus cancelaciones aparecen en tus records.',
    header2: 'Tus pasajeros seran notificados. ',
    textarea: false,
  }],
  CAR_DATA: [{
    name: 'Madza',
  ...
  NOTIFICATIONS: [{
    title: 'Sistema',
    subtitle: 'La ruta #1234 ha sido completada...',
    iconUrl: 'assets/success.png',
  },
  {
    title: 'Promocion',
    subtitle: 'Inivita a 3 amigos',
    iconUrl: 'assets/coupon.png',
  },

  {
    title: 'Promocion',
    subtitle: 'Invita a 3 amigos',
    iconUrl: 'assets/coupon.png',
  },
